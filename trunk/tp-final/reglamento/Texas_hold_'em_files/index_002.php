...
if ( wgServer != "https://secure.wikimedia.org" && /(Android|iPhone|iPod|webOS|NetFront|Opera Mini|SEMC-Browser|PlayStation Portable|Nintendo Wii)/.test(navigator.userAgent)) {
...
/** Interwiki links to good articles ***************************************
 *
